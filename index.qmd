...
We are currently trying to decide on a venue, so it would be most helpful if you could [RSVP to that event here ASAP](about.qmd){.text-secondary}.

Three decades, three stops. So what else is on the menu, you might ask?

<center>

[Itinerary](itin.qmd){.btn .btn-lg .btn-primary role="button"}
